    ...
    with ucus_csv.open(
        ...
        try:
            ...
            while True:
                ...
                if hedefte_sayac >= 5:
                    hedefe_varis_hatasi = hedef_mesafesi
                    print(
                        "✅ Hedefe ulaşıldı. Hata: "
                        f"{hedefe_varis_hatasi:.2f} m"
                    )
                    break
            ...
            son_hedef_mesafesi = son_konum.get(
                "hedef_mesafesi",
                math.nan,
            )
            ...
            print(
                f"Hedefe varış hatası: "
                f"{hedefe_varis_hatasi:.2f} m"
            )
            print(
                f"İniş sonrası hedef mesafesi: "
                f"{son_hedef_mesafesi:.2f} m"
            )
            print(
